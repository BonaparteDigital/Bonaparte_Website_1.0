        ...
        <div id="footer_content_desktop" className="hidden md:flex md:flex-col mx-auto px-4">
          <div id="upper-footer" className="flex container max-w-screen-xl px-10 md:mt-6">
            ...
            <div className="w-1/3 text-center">
              ...
              <a href='https://services.bonapartedigital.com/meetings/bonaparte' aria-label="Book RDV" className="cta_book_rdv md:inline-block text-md font-bold bg-olive text-green px-6 py-2 rounded-full transition duration-300 hover:shadow-[-5px_5px_0px_0px_#EC8602] hover:transform hover:translate-x-1.5 hover:-translate-y-1.5">Book a RDV</a></div>
